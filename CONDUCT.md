# fsmpy Code of Conduct

fsmpy is an engaged and respectful community made up of people
from all over the world. Your involvement helps us to further our
mission.

The goal of fsmpy is to become the go to project for the 
application of Fuzzy Set theory, freely available to the reader and 
everyone else. As any other open source project, it requires a community 
of people who maintain and contribute to it. The quality of the project 
depends on the engagement and size of the community; thus you as a user 
of fsmpy directly benefit from creating positive environment 
that encourages people to contribute to the project.
...
[*George Sidiropoulos*](mailto:georgesid95@gmail.com) or [*Kiriakos Apostolidis*](mailto:kyriapos1@ihu.cs.gr) (who are both maintainers of fsmpy), [*George Papakostas*](mailto:gpapak@cs.ihu.gr) or anyone from [*Machine Learning and Vision Research Group*](https://github.com/MachineLearningVisionRG).

This code applies equally to founders, developers, mentors and new community
members, in all spaces managed by fsmpy. This
...
7. **When we disagree, try to understand why**. Disagreements, both social and
   technical, happen all the time and fsmpy is no exception.  Try to
...
This code of conduct is based on [the Scikit-Optimize COC](https://github.com/scikit-optimize/scikit-optimize/blob/master/CONDUCT.md), which is based on [the Jupyter team COC](https://github.com/jupyter/governance/blob/4345f740ed98c7aa578a9482fa36cf5de663ab54/conduct/code_of_conduct.md) as well as [http://todogroup.org/opencodeofconduct/](http://todogroup.org/opencodeofconduct/).
